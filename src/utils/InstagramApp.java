...
import utils.InstagramDialog.OAuthDialogListener;
...
public class InstagramApp {
		...
		new Thread() {
			...
			public void run() {
				...
				try {
					...
					String profile = jsonObj.getJSONObject("data").getString(
							"profile_picture");
					String followers = jsonObj.getJSONObject("data")
							.getJSONObject("counts").getString("followed_by");
					String following = jsonObj.getJSONObject("data")
							.getJSONObject("counts").getString("follows");
					mSession.setData(profile, followers, following);
					Log.i(TAG, "Got name: " + name + ", bio [" + profile + "]");
				} catch (Exception ex) {
					what = WHAT_ERROR;
					ex.printStackTrace();
				}
	...
	public String getFollowers() {
		return mSession.getFollowers();
	}

	public String getFollwing() {
		return mSession.getFollowing();
	}
